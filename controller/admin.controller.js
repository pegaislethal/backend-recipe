...
const createAdmin = async (req, res) => {
    ...
    try {
        ...
        if(admin){
            res.status(500).json({message: "admin already exist"})
        }
        ...
        res.status(201).json({ message: "Admin created successfully. Please verify your email with the OTP sent.", newAdmin });
    } catch (error) {
